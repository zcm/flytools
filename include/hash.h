/** @file hash.h
 * This is the header file for the hash functions used in the dictionary type provided by the
 * Flytools. To use it the functions herein, simply include this file in your source.
 *
...
/**
 * Computes the uncompressed hash of the given string, returned as an unsigned integer. This
 * hash can be used for many things, such as for verification or for indices into a dictionary
 * or associative list.
...
/**
 * Compresses a given hash key k over the possible range n. In other words, this function
 * ensures that a hash k is suitable for use as an index into an array of size n.
