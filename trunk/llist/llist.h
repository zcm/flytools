/** @file llist.h
 * This is the header file for the linked list types provided by the Flytools. To use any
 * one of them (or multiple), simply include this header file in your source code.
 *
