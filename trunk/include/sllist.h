/** @file sllist.h
 * This is the header file for the singly linked list abstract data type provided by the
...
struct SINGLE_LINKED_LIST {
	struct SINGLE_LINKED_LIST_NODE *head; //!< The header or sentinel node for this linked list.
...
typedef single_linked_list sllist;

// allocation
/**
 * Allocates a singly linked list with the specified allocation routine.
...
sllist *sllist_alloc();
/**
 * Frees all of the memory associated with this singly linked list using
...
/**
 * Frees all of the memory associated with this singly linked list. Any
...
// initialization
/**
 * Initializes a previously allocated singly list that was allocated with
...
/**
 * Initializes a previously allocated singly linked list. This will
 * allocate the proper header node and set up the links.
 * @param list the singly linked list to initialize
 */
void sllist_init(sllist *list);
/**
 * Allocates a singly linked list with the specified allocation routine and
 * then initializes it with a call to sllist_init().
 * @param alloc_callback the allocation routine for which to allocate this singly linked list
 ...
 * @param elem a pointer to the element that will be inserted into the list
 */
void sllist_insert_left(sllist *list, void *elem); // alias function
/**
 * Alias function for sllist_insert_elem_after_head().
 * @param list the list in which to insert the element
 * @param elem a pointer to the element that will be inserted into the list
 */
void sllist_push(sllist *list, void *elem); // alias function
/**
