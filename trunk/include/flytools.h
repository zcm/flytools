/** @file flytools.h
 * This is the main header file for the Flytools. It implicitly includes all of the other
 * Flytools projects in order to reduct the amount of typing per file one must do to use the
 * types provided by the Flytools.
 *
